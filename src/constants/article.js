            ...
            sub_sections: [
                {
                    title: "Athletics",
                    number: 2.1,
                    content: `The NU mascot is Paws. The school colors are red and black with white trim. The fight song, "All Hail, Northeastern", was composed by Charles A. Pethybridge, Class of 1932.[citation needed]
            ...
            sub_sections: [
                {
                    ...
                    number: 3.1,
                    content: `
                    Northeastern is located in Boston's Fenway, Roxbury, South End, and Back Bay neighborhoods adjacent to Huntington Avenue near the Museum of Fine Arts and Symphony Hall. The area is also known as the Fenway Cultural District.[120]

Although located in the heart of Boston, the Northeastern campus is still filled with trees, flowers, and grassy quads. Since the late 1990s, Northeastern has been considered a model of design for urban universities and has twice won the "most beautiful new or renovated exterior space" award (presented by the American Institute of Architects) in 2001 and 2004.[121] In 2019, the campus was officially designated as an arboretum by ArbNet, making it the only campus in Boston to receive the designation.[122][123]

The first baseball World Series took place on the Huntington Avenue Grounds, now part of the Northeastern University campus. The site is commemorated in front of Churchill Hall by a statue of Cy Young.[124]
                    `
                },
                {
                    ...
                    number: 3.2,
                    content: `
                    The 2011 Sustainable Endowments Institute's College Sustainability Report Card issued Northeastern a grade of "A-" for its environmental sustainability efforts and programs.[125] Additionally, the Princeton Review rated Northeastern as one of the top 15 "Green Colleges" in the nation in 2010.[126] In 2011, the GreenMetric World University ranking evaluated Northeastern as the second greenest university in the world, and first in the US.[127] Northeastern placed first in the rankings again in 2014.[128]

In accordance with a Boston zoning code amendment in 2007,[129] International Village residence hall was certified as a LEED Gold building in 2010.[130] Dockser Hall was the first building on campus to achieve LEED certification, also Gold, with the completion of its renovation in 2010.[131] East Village was rated LEED Silver in 2016 and the Interdisciplinary Science and Engineering Complex was rated LEED Gold in 2018.[132][133]
                    `
                }
            ]
        },
